...
public class ScrollViewer extends FrameLayout {

	public interface ScrollViewerListener {
	    abstract void onScrollChanged(ScrollViewer scrollView, int x, int y, int oldx, int oldy);
	}

	private ScrollViewerListener ScrollViewerListener = null;
	 ...
	 */
	 ...
	 public void setScrollViewListener(ScrollViewerListener scrollViewListener) {
		 this.ScrollViewerListener = scrollViewListener;
	 }

	 @Override
	 protected void onScrollChanged(int x, int y, int oldx, int oldy) {
		 super.onScrollChanged(x, y, oldx, oldy);
		 if(ScrollViewerListener != null) {
			 ScrollViewerListener.onScrollChanged(this, x, y, oldx, oldy);
		 }
	 }
